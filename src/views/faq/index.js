  ...
  return (
    ...
    >
      ...
      <Grid className={styles.description} color="primary">
        ...
        Ainda não realizados pedidos ou pagamentos pelo site, você terá que ligar
        para o comerciantes e combinar diretamente com ele.
        <Typography component="p" variant="h2">
          Meu comércio não está na página principal, como posso achá-la?
        </Typography>
        A página principal só mostra 12 comércios por vez e cada vez que você
        atualiza o site, as opções são diferentes. Você consegue achar a sua página
        filtrando pelo campo departamento que ela está cadastrada!
        <Typography component="p" variant="h2">
        ...
        Fomos participantes do Global Online Startup Weekend Covid-19 de Cabo Verde,
        onde fomos vencedores na área Empresas. Após isto decidimos continuar com o
        projeto visando auxiliar os comerciantes do mercado sucupira.
        <Typography component="p" variant="h2">
          Possui outras duvidas?
        </Typography>
        Iremos lhe auxiliar com o maior prazer, nos envie um email para o seguinte
        email:
        <br />
